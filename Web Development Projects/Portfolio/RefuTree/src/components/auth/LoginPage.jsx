...
import { 
  User, Lock, Eye, EyeOff, AlertCircle, CheckCircle, 
  Building, Shield, Users, Heart, Globe
} from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Vluchtelingen Management Systeem
          </p>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono text-gray-800">maria / maria123</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Caseworker:</span>
                <span className="font-mono text-gray-800">lisa / lisa123</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Volunteer:</span>
                <span className="font-mono text-gray-800">peter / peter123</span>
              </div>
            </div>
          </div>
        </div>
