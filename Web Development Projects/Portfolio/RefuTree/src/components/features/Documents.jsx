...
import { 
  Plus, Search, Filter, Upload, Download, Eye, Edit, Trash2, 
  FileText, FileImage, FileArchive, CheckCircle, 
  AlertTriangle, Clock, User, Calendar, Shield, Star,
  X, Save, Send, FolderOpen, FileCheck, FileX
} from 'lucide-react';
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(document =>
        ...
        document.residentName.toLowerCase().includes(searchTerm.toLowerCase()) ||
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-gray-600">{document.residentName}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                ...
                <div className="space-y-2">
                  <div className="text-sm">
                    <span className="font-medium text-gray-700">Geüpload door:</span>
                    <p className="text-gray-600">{document.uploadedBy}</p>
                  </div>
                  {document.verifiedBy && (
                    <div className="text-sm">
                      <span className="font-medium text-gray-700">Geverifieerd door:</span>
              ...
              <div className="flex items-center justify-between text-sm text-gray-500 border-t pt-4">
                <div className="flex items-center gap-4">
                  ...
                  {document.verifiedAt && (
                    <span>Verificatie: {formatDateTime(document.verifiedAt)}</span>
                  )}
                </div>
                <div className="flex items-center gap-2">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl">
            <div className="p-6 border-b">
              ...
              <p className="text-gray-600 mt-1">Functie komt in de volgende stap</p>
            </div>
            <div className="p-6">
              <button
