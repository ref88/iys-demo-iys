...
const AuditTrail = ({
  ...
  // Load audit logs from props or localStorage
  useEffect(() => {
  ...
  return (
    <div className='bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full h-full flex flex-col'>
      {/* Header */}
      <div className='flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700'>
        ...
        <div className='flex items-center gap-2'>
          <button
            onClick={exportLogs}
            className='flex items-center gap-2 px-3 py-2 text-sm bg-blue-50 dark:bg-blue-900 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-800 transition-colors'
          >
              ...
              {filteredLogs.map((log, index) => (
                ...
                >
                  <div className='flex-shrink-0'>
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-sm ${getActionColor(log.actionType)}`}
                    >
                  ...
                  <div className='flex-1 min-w-0'>
                    <div className='flex items-center gap-2 mb-1'>
                      ...
                      <span
                        className={`text-sm px-2 py-1 rounded-full ${getActionColor(log.actionType)}`}
                      >
                        {log.actionType}
                      </span>
                      <span className='text-gray-400'>•</span>
