  ...
  return (
    <div className='space-y-2'>
      ...
      <div className='text-xs text-gray-500'>
        ...
        {isOverCapacity && (
          <span className='text-red-600 ml-2'>⚠️ Overcapaciteit</span>
        )}
        {isNearCapacity && !isOverCapacity && (
          <span className='text-orange-600 ml-2'>⚠️ Bijna vol</span>
        )}
      </div>
    </div>
  );
...
const FlowMetrics = ({ residents }) => {
  ...
  const flowData = useMemo(() => {
    const instroom = residents.filter((r) => {
      ...
      return (
        arrivalDate.getMonth() === thisMonth &&
        arrivalDate.getFullYear() === thisYear
      );
    }).length;
            ...
            <div className='flex items-center p-3 bg-orange-50 border border-orange-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-orange-700'>
                  Bezetting is hoger dan 85% (
                  {((metrics.present / capacity) * 100).toFixed(1)}%)
                </p>
              </div>
            </div>
          )}
            ...
            <div className='flex items-center p-3 bg-red-50 border border-red-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-red-700'>
                  Er zijn meer bewoners dan beschikbare plaatsen
                </p>
              </div>
            </div>
          )}
            ...
            <div className='flex items-center p-3 bg-blue-50 border border-blue-200 rounded-lg'>
              ...
              <div>
                ...
                <p className='text-sm text-blue-700'>
                  Bezetting is lager dan 50% - ruimte voor nieuwe bewoners
                </p>
              </div>
            </div>
          )}
